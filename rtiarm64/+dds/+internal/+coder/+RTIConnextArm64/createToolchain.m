...
% This function was generated using target data export.
    ...
    cmakebuilder.ToolchainFile = fullfile(fileparts(mfilename('fullpath')),'rti_connext_armv8.cmake');
    ...
    % Create target.Toolchain "RTI Connext 6.x for Arm 64 bits Project"
    ...
    toolchain.Name = "RTI Connext 6.x for Arm 64 bits Project";
